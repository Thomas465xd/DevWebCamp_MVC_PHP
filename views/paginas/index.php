        ...
        <?php foreach($ponentes as $ponente) { ?>
            ...
            <div <?php aos_animacion(); ?> class="speaker">
                <picture>
                    ...
                    <source srcset="/img/speakers/<?php echo $ponente->imagen; ?>.jpg" type="image/jpeg">
                    <img src="/img/speakers/<?php echo $ponente->imagen; ?>.jpg" class="speaker__imagen" loading="lazy" alt="Imagen de <?php echo $ponente->nombre; ?>">
                </picture>

                <div class="speaker__informacion">
                    <h3 class="speaker__nombre">
                    ...
                    <ul class="speaker__listado-skills">
                        <?php 
                            ...
                            foreach($tags as $tag) {
                        ?>
                            <li class="speaker__tag"><?php echo $tag; ?></li>
                        <?php } ?>
                    </ul>
                </div>
            </div>
